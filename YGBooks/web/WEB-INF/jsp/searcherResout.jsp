                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="images/bd${book.bid}.jpg" alt="" class="pro-image-front">
                                <img src="images/bd${book.bid}.jpg" alt="" class="pro-image-back">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="${pageContext.request.contextPath}/toSingle?bid=${book.bid}" class="link-product-add-cart">详情</a>
                                    </div>
                                </div>
                            ...
                            <div class="item-info-product ">
                                <h4><a href="${pageContext.request.contextPath}/toSingle?bid=${book.bid}">${book.bookName}</a></h4>
                                <div class="info-product-price">
                                    <span class="item_price">￥${book.cost}</span>
                                    <del>￥${book.preCost}</del>
                                </div>
                            </div>
                        </div>
                    </div>
