...
<div class="banner-bootom-w3-agileits">
    <div class="container">
                ...
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        <li data-thumb="images/d3.jpg">
                            <div class="thumb-image"> <img src="images/bid${book.bid}.jpg" data-imagezoom="true"
        ...
        <div class="col-md-8 single-right-left simpleCart_shelfItem">
            <h3>${book.bookName}</h3>
            <p><span class="item_price">￥${book.cost}</span> <del>￥${book.preCost}</del></p>



            <div class="occasion-cart">
                <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                    <form action="${pageContext.request.contextPath}/addToCart?bid=${book.bid}" method="post">
                        <fieldset>
                ...
                <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out button2">
                    <form action="${pageContext.request.contextPath}/buySingle?bid=${book.bid}" method="post">
                        <fieldset>

                            <input type="submit" name="submit" value="立即购买" class="button">
                        </fieldset>
                    </form>
                </div>
            </div>
