...
<div class="new_arrivals_agile_w3ls_info">
    <form class="container" action="${pageContext.request.contextPath}/updateInformation">
        <h3 class="bars">信息修改</h3>
        ...
        <div class="input-group w3_w3layouts">
            ...
            <input type="text" class="form-control" placeholder="Email" aria-describedby="basic-addon1" name="password">
        </div>
        <div class="input-group w3_w3layouts">
            <span class="input-group-addon" id="basic-addon3">收货地址</span>
            <input type="text" class="form-control" placeholder="location" aria-describedby="basic-addon1" name="address">
        </div>
        <div class="input-group w3_w3layouts">
            <span class="input-group-addon" id="basic-addon4">联系方式</span>
