...
<div class="banner_bottom_agile_info">
    <div class="container">
        ...
        <h1>
            <c:if test="${isCart}">
                <a href="${pageContext.request.contextPath}/payForCart?sum=${sum}"><span class="label label-success">立即支付</span></a>
            </c:if>
            <c:if test="${!isCart}">
                <a href="${pageContext.request.contextPath}/payForSingle?sum=${sum}"><span class="label label-success">立即支付</span></a>
            </c:if>
