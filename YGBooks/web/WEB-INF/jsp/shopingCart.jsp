...
<div class="banner_bottom_agile_info">
    <div class="container">
            ...
            <table class="table">
                ...
                <c:forEach items="${user.books}" var="book">
                    <tr>
                        ...
                        <th></th><td><a href="${pageContext.request.contextPath}/removeBook?bid=${book.bid}"><i class="fa fa-remove"></i> </a></td>
                    </tr>
        ...
        <h1>
            <a href="${pageContext.request.contextPath}/buyAll"><span class="label label-success">购买</span></a>
        </h1>
    </div>
</div>
